...
batch_size = 10
epochs = 50
save_root = '/home/k/kai/CheckPoints/ResNet101_5_Batch_10_015'
...
slow_fast = torch.hub.load('facebookresearch/pytorchvideo:main', model='slowfast_r101', pretrained=True).cuda()
...
optimizer = SGD(slow_fast.parameters(), lr=0.015, momentum=0.9,weight_decay=0.001)
