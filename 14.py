...
batch_size = 10
epochs = 50
save_root = '/home/k/kai/CheckPoints/Knl_5_Batch_10_02'
...
slow_fast.blocks[0].multipathway_blocks[0].conv.kernel_size = (1,5,5)
slow_fast.blocks[0].multipathway_blocks[1].conv.kernel_size = (5,5,5)
